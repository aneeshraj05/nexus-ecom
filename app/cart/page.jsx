...
const Cart = () => {
  const { products, cartItems, setCartItems, addToCart, updateCartQuantity, getCartCount } = useAppContext();
      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
        <div className="flex-1">
          ...
          <div className="flex justify-between mt-6">
            <button onClick={()=> router.push('/all-products')} className="group flex items-center gap-2 text-orange-600">
              Continue Shopping
            </button>
